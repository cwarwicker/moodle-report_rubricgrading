 ...
 * Grader entity.
 *
 * Provides user profile columns and filters for the teacher who marked
 * the submission. Uses a distinct table alias from the student entity
...
class grader extends base {
    ...
    protected function get_default_entity_title(): lang_string {
        return new lang_string('gradedby', 'report_rubricgrading');
    }
    ...
    protected function get_all_columns(): array {
        ...
        $columns[] = (new column(
            'firstname',
            new lang_string('graderfirstname', 'report_rubricgrading'),
        ...
        $columns[] = (new column(
            'lastname',
            new lang_string('graderlastname', 'report_rubricgrading'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
        ...
        $columns[] = (new column(
            'username',
            new lang_string('graderusername', 'report_rubricgrading'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
        ...
        $columns[] = (new column(
            'email',
            new lang_string('graderemail', 'report_rubricgrading'),
            $this->get_entity_name()
        ))
            ->add_joins($this->get_joins())
            ->set_type(column::TYPE_TEXT)
